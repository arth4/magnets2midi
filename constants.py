SYNTH_ONLY = ['Electric Bass (finger)', 'Electric Bass (pick)',
                  'Fretless Bass', 'Slap Bass 1', 'Slap Bass 2',
                  'Synth Bass 1', 'Synth Bass 2', 'Synth Strings 1', 'Synth Strings 2',
				  'Synth Choir', 'Synth Brass 1', 'Synth Brass 2',
                  ...
                  'Pad 6 (metallic)', 'Pad 7 (halo)', 'Pad 8 (sweep)', 'Synth Drum',
                  'Reverse Cymbal']

NO_SFX = ['Acoustic Grand Piano', 'Bright Acoustic Piano',
